 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "sort" (string)  Name of a response property sort the result by as per [filtering and sorting](../../../../meta/filtering#query-sort).
 @return PaginatedRepositoryPermissions*/
func (a *DefaultApiService) TeamsUsernamePermissionsRepositoriesRepoSlugGet(ctx context.Context, username string, repoSlug string, localVarOptionals map[string]interface{}) (PaginatedRepositoryPermissions,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
